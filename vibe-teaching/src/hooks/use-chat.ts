			...
			const testScenes: Scene[] = [
				{
					...
					id: uuidv4(),
					class:
						"w-[1920px] h-[1080px] flex flex-col items-center justify-center px-[1920px/12.2] py-[1080px/12] bg-gray-50 dark:bg-gray-900",
					...
					children: [
						{
							...
							id: uuidv4(),
							class:
								"max-w-[1536px] text-8xl md:text-9xl font-bold text-center text-blue-600 dark:text-blue-400 animate-fade-in",
							durationInFrames: 150,
					...
					children: [
						{
							...
							id: uuidv4(),
							class:
								"max-w-[1536px] text-6xl md:text-7xl font-bold text-center text-gray-700 dark:text-gray-300 my-6",
							durationInFrames: 150,
						...
						},
						{
							...
							id: uuidv4(),
							class:
								"max-w-[1344px] text-3xl md:text-4xl text-center text-gray-700 dark:text-gray-300 leading-relaxed",
							durationInFrames: 150,
				...
				},
				{
					...
					children: [
						...
						},
						{
							...
							id: uuidv4(),
							class:
								"max-w-[1536px] h-[864px] object-contain rounded-lg shadow-lg mx-auto my-4",
							durationInFrames: 300,
						...
						},
						{
							...
							id: uuidv4(),
							class:
								"max-w-[1344px] text-3xl md:text-4xl text-center text-gray-700 dark:text-gray-300 leading-relaxed mx-4",
							durationInFrames: 150,
