...
export default function Preview({ selectedItem, isLoading = false }: PreviewProps) {
      ...
      <div className="flex-grow flex items-center justify-center relative bg-gray-100 rounded-lg">
        {isLoading ? (
          ...
          <div className="text-center p-8">
            ...
            <p className="text-gray-400 text-sm mt-2">Select an item from the timeline to preview</p>
          </div>
        )}
      </div>
    </div>
