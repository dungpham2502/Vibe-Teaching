...
export default function ChatInterface({
  ...
  // Initialize messages with any provided initial messages
  ...
  // Update the simulateAIResponse function to call onReceiveMessage
  const simulateAIResponse = async (userMessage: string) => {
    const response = await getAIResponse(userMessage)

    // Call the onReceiveMessage prop if provided
    if (onReceiveMessage) {
  ...
  // Update the handleSubmit function to call the onSendMessage prop
    ...
    >
      <header className="h-12 flex items-center px-4 bg-gray-50">
        <div className="w-full flex items-center justify-between px-2">
          ...
          <h1 className="text-base font-medium text-gray-800">Your App Name</h1>
